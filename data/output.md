...
```mermaid
graph TB
    A[Laveur de plaque ELISA] --> B[Système de distribution]
    B --> C[Incubateur]
    C --> D[Lecteur ELISA]
    D --> E[Ordinateur]
```
...
![Schéma d'un pH-mètre montrant un voltmètre à haute impédance connecté à deux électrodes (électrode Ag/AgCl et électrode de mesure) plongées dans une solution à analyser. Le schéma montre également le régulateur de température, les pôles des électrodes de référence et de mesure, le verre spécial perméable aux ions, le KCl, et le pont salin (membrane poreuse).]
...
[Diagram showing a top-loading balance with labeled components: Masse (weight), Plateau (platform), Raccords souples (flexible connections), and Colonne (column)]

**Figure 11. Balance à substitution**

[Diagram showing a substitution balance with labeled components: Échelle de lecture (reading scale), Réglage de sensibilité (sensitivity adjustment), Masse connue (known mass), Mécanisme de réglage du zéro (zero adjustment mechanism), Couteau (knife edge), and Masse inconnue (unknown mass)]
...
[Diagram showing two types of heating elements: Résistance à immersion (Immersion heater) - a U-shaped tube, and Résistance externe (External heater) - a flat rectangular element]
...
[Image shows a biological safety cabinet with a transparent front panel, biohazard symbol, control panel, work surface with perforated grilles, and ventilation system]
...
3. Convient pour le travail avec des agents correspondant aux niveaux de sécurité biologique1, 1, 2 ou 3.
4. Système de filtration : filtre HEPA situé dans le système d'évacuation qui peut ou non être relié à l'extérieur.
5. Inconvénient : Ne protège pas l'échantillon qui y est manipulé.                                                                                                                                                                 |
| **CLASSE II — TYPE A**                                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
4) Système de filtration : deux filtres HEPA, l'un situé sur la surface de travail et l'autre sur le système d'évacuation, qui peut être ou non relié à l'extérieur. Si le système d'évacuation est relié à l'extérieur, la connexion se fait par un manchon de raccordement.
5) Recycle environ 70 % du volume d'air et en renouvelle 30 %. |


<sup>1</sup> Voir la classification des agents en niveaux de sécurité biologique dans la section « Sécurité biologique »
